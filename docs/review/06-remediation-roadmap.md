...
| WS-07 Marketing claim/pricing parity | Product Lead + Web Lead | 2026-02-16 | 2026-02-20 | In Progress | 92% | 2026-02-11 | 2026-02-18 | Implemented parity updates across pricing/hero/CTA/features metadata (14-day trial, £50/£950, enforced limits) plus distributed-ready marketing API rate limiting (Upstash with local fallback). Remaining: automated consistency assertion against canonical plan source in CI and production env rollout confirmation. |
...
| WS-10 Test matrix + release gates | QA Lead + Eng Leads | 2026-02-21 | 2026-03-07 | In Progress | 76% | 2026-02-11 | 2026-03-04 | Added CI agent job + web tests + installer smoke checks; agent release now blocks on test failures. Remaining: Stripe replay/order regression suite and refund/dispute policy matrix automation. |
