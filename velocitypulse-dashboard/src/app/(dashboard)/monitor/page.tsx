...
import type { Device, Category, NetworkSegment, ViewMode, SortField, SortDirection } from '@/types'
import type { RealtimeChannel } from '@supabase/supabase-js'
import {
  Loader2, Search, RefreshCw, Settings2
} from 'lucide-react'
...
// Local storage keys
const STORAGE_KEYS = {
  viewMode: 'velocitypulse-monitor-viewMode',
  sortField: 'velocitypulse-monitor-sortField',
  sortDirection: 'velocitypulse-monitor-sortDirection',
  groupBySegment: 'velocitypulse-monitor-groupBySegment',
}
...
export default function MonitorPage() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel(`monitor-${organization.id}`)
      .on(
        'postgres_changes',
        {
          event: '*',
